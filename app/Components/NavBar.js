  ...
  return (
    <nav className='flex items-center justify-between bg-blue-500 py-4 px-10 shadow-md shadow-slate-700 text-white mb-5'>
      ...
      <ul className='flex space-x-10 font-semibold text-lg'>
        <li><Link href={'/login'} className='px-3 py-2 shado hover:bg-yellow-400 shadow-md shadow-transparent hover:shadow-slate-500 rounded-md text-shadow-sm'>Sign In</Link></li>
