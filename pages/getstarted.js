...
const subjectsList = ["Python", "C", "Java", "Mysql"];
...
const getstarted = () => {
    useEffect(() => {
        ...
        if (emuser) {
            ...
            const teacherFormSubmit =
                document.querySelector("#teacherFormSubmit");
            teacherFormSubmit.addEventListener("click", (e) => {
                ...
                if (document.querySelector("#teacherName").value === "") {
                    ...
                    if (
                        document.querySelector("#teacherPassword").value ===
                        document.querySelector("#teacherCpassword").value
                    ) {
                        let url =
                            "/api/signup?name=" +
                        ...
                        fetch(url, { method: "POST" })
                            ...
                            .then((data) => {
                                if (data.msg === "signup success") {
                                    ...
                                    document.cookie =
                                        "emuser=" +
                                        document.querySelector("#teacherId")
                                            .value +
            ...
            const studentFormSubmit =
                document.querySelector("#studentFormSubmit");
            studentFormSubmit.addEventListener("click", (e) => {
                ...
                if (document.querySelector("#studentName").value === "") {
                    ...
                    if (
                        document.querySelector("#studentPassword").value ===
                        document.querySelector("#studentCpassword").value
                    ) {
                        let url =
                            "/api/signup?name=" +
    ...
    return (
        <>
            <NavBar />
            <h1 className="text-white text-shadow font-bold text-3xl md:text-4xl text-center">
                Lets Start By Creating Your Account
            </h1>
            <div className="mt-10">
                <h1 className="text-xl font-bold text-white text-center text-shadow">
                    Select Your Role:
                </h1>
                <br />
